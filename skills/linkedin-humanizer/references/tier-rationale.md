...
- **Negative parallelism ("X isn't Y, it's Z")**: per Author's 2026-04-27 hard ban. The pattern is the #1 AI-tell after em dashes. Used by JFK historically, but in 2026 LinkedIn context it reads as ChatGPT in 90% of cases.
