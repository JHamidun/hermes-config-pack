...
description: "Справочник по перестройке компании вокруг ИИ по методике."
user_description: "Справочник по перестройке компании вокруг ИИ по методике ExO 3.0: куда идти, из чего собирается новая операционная модель, по какому плану двигаться и как удержать границы полномочий у ИИ-агентов. Нужен собственнику или руководителю, у которого пилоты с ИИ дали прирост и застряли, а цельной картины перехода нет."
version: 1.3.0
license: MIT
metadata:
  hermes:
    category: thinking-and-methodology
    tags: [building, exo, git, openai]
    source: claude-code-config-pack
---
## Когда применять

Справочник ExO 3.0 (OpenExO) для AI-перестройки компании: Intelligence Stack, REWRITE, Edge Twin, DRIVE/SHAPE, MTP. Триггеры: «экспоненциальная организация». НЕ маркетинг/CRO.
