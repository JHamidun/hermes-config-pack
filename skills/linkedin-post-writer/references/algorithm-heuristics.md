...
Based on EnterpriseTool paper (arXiv 2501.16450), AuthoredUp 2026 reach data, Trust Insights Q1 2026 guide, and Social Media Today reporting on Gyanda Sachdeva's anti-pod measures.
...
- **0 hashtags** performs equal to or better than 5+ in 2026 (EnterpriseTool uses semantic embeddings, not tag matching)
...
- Over-posting: 2+ posts/day triggers cannibalization signal (EnterpriseTool deprioritizes accounts posting 2+/day).
...
Observed real consequence: creators have been observed dropping >95% impressions overnight after pod detection.
