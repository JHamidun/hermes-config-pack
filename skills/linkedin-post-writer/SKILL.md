...
description: "Собирает пост для LinkedIn по одному из десяти каркасов."
user_description: "Собирает пост для LinkedIn по одному из десяти каркасов, которые реально собирали тысячи реакций у известных авторов, и подгоняет его под правила площадки: зацепка в первые 210 символов, длина в рабочем коридоре, ссылки в первый комментарий. Нужен, когда есть тема и хочется опереться на проверенную конструкцию, а не изобретать структуру с нуля."
version: 1.0.0
license: MIT
metadata:
  hermes:
    category: writing-and-communication
    tags: [linkedin, post, writer]
    source: claude-code-config-pack
---
## Когда применять

Viral LinkedIn посты на hook-формулах: хук+пост, Publora-schedule. Триггеры: «hook formula», «разбери viral пост».
