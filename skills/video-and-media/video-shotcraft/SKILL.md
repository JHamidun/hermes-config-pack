...
description: "Делает промо-ролик продукта из скриншотов и сайта."
...
metadata:
  hermes:
    ...
    tags: [video, shotcraft, ffmpeg, python, git, figma, audio]
    source: claude-code-config-pack
---
## Когда применять

Промо-ролики продукта на Remotion: 153 рецепта кадров, 2.5D-проходы, шаблон Ink Press. Триггеры: «видео из лендинга», «шоурил». НЕ: футаж→video-editor; reels→video-montage.
