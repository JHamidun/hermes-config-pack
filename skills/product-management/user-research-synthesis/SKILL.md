...
description: "Превращает сырьё исследований."
user_description: "Превращает сырьё исследований — расшифровки интервью, опросы, юзабилити-тесты, обращения в поддержку — в связные выводы: повторяющиеся темы, персоны, карту эмпатии и цитаты-доказательства к каждому утверждению. Нужен, когда материала накопилось много, а внятного ответа «что мы поняли» из него так и не вышло."
version: 1.0.0
license: MIT
metadata:
  hermes:
...
Синтез исследований в инсайты: интервью, опросы → темы, персоны; CustDev: респонденты, карта эмпатии. Триггеры: «синтез интервью», «юзабилити».
