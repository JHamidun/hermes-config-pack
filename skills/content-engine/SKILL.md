---
name: content-engine
description: "Берёт один исходник — статью, заметку, транскрипт."
user_description: "Берёт один исходник — статью, заметку, транскрипт, демо продукта — и раскладывает его в посты под каждую площадку: X, LinkedIn, короткие видео, YouTube. Нужен, когда хочется присутствовать везде, не превращая свой текст в безликий шаблонный контент."
version: 1.0.0
license: MIT
metadata:
  hermes:
    category: marketing
    tags: [content, engine, telegram, video]
    source: claude-code-config-pack
---
## Когда применять

Platform-native контент из одного исходника под X, LinkedIn, TikTok, YouTube: контент-план, посты. Триггеры: «контент для соцсетей».
