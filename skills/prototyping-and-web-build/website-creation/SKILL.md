...
description: "Создание современных лендингов и сайтов."
version: 1.0.0
license: MIT
metadata:
  hermes:
    category: prototyping-and-web-build
    tags: [website, creation, python]
    source: claude-code-config-pack
---
## Когда применять

Создание современных лендингов и сайтов — от vanilla HTML до React+Tailwind (Lovable-style). Триггеры: «создай сайт», «landing page», «website».
