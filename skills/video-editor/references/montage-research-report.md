...
File: `~/.hermes/skills/video-and-media/video-editor/references/silence-removal.md`
```markdown
...
Save to: `~/.hermes/skills/video-and-media/video-generation/luts/Kodak2383_D55.cube`

File: `~/.hermes/skills/video-and-media/video-generation/references/color-grading.md`
```markdown
...
ffmpeg -i input.mp4 \
  -vf "lut3d=file='~/.hermes/skills/video-and-media/video-generation/luts/Kodak2383_D55.cube':interp=tetrahedral" \
...
File: `~/.hermes/skills/video-and-media/video-editor/scripts/add_captions.py`
```python
#!/usr/bin/env python3
...
File: `~/.hermes/skills/video-and-media/video-editor/scripts/beat_sync_edit.py`
```python
#!/usr/bin/env python3
...
File: `~/.hermes/skills/video-and-media/video-editor/scripts/karaoke_captions.py`
```python
#!/usr/bin/env python3
...
File: `~/.hermes/skills/video-and-media/video-editor/scripts/reframe_9x16.py`
```python
#!/usr/bin/env python3
...
def yolo_crop(input_file, output_file):
    ...
    import os
    repo = '~/.hermes/ccpack/tools/Autocrop-vertical'  # adjust path
    subprocess.run([
...
File: `~/.hermes/skills/video-and-media/video-editor/scripts/speed_ramp.py`
- Contains `build_speed_ramp()` function from Section 3I above.

**P2.5: xfade chain builder reference**

File: `~/.hermes/skills/video-and-media/video-editor/references/xfade-transitions.md`
```markdown
...
File: `~/.hermes/skills/video-and-media/video-generation/references/remotion-overlays.md`
...
File: `~/.hermes/skills/video-and-media/video-generation/scripts/motion_graphics.py`
...
File: `~/.hermes/skills/video-and-media/video-generation/references/manim-patterns.md`
...
File: `~/.hermes/skills/video-and-media/video-editor/scripts/scene_detect.py`
```python
...
File: `~/.hermes/skills/video-and-media/video-editor/references/sound-design.md`
