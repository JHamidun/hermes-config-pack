---
name: ultra-think
description: "Deep analysis and problem solving with multi-dimensional."
version: 1.0.0
license: MIT
metadata:
  hermes:
...
2. **Parse the Problem or Question**
   - Extract the core challenge from: текст, который пользователь написал вместе с вызовом навыка
