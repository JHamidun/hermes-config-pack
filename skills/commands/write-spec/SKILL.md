---
name: write-spec
description: "Write a feature spec or PRD from a problem statement or."
version: 1.0.0
license: MIT
metadata:
  hermes:
    ...
    origin: "command"
    argument_hint: "<feature or problem statement>"
---
...
```
/write-spec текст, который пользователь написал вместе с вызовом навыка
```
