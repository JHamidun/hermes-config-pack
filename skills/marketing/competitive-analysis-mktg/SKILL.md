...
description: "Разбирает конкурентов с маркетинговой стороны."
user_description: "Разбирает конкурентов с маркетинговой стороны: как они себя подают, что обещают, о чём пишут и каких тем в их контенте нет. На выходе — профиль конкурента и заготовка сравнительной страницы «мы и они», которая работает и на поиск, и на продажи."
version: 1.0.0
license: MIT
metadata:
  hermes:
    category: marketing
    tags: [competitive, analysis, mktg, video]
    source: claude-code-config-pack
---
## Когда применять

Конкуренты в маркетинге: месседжинг, контент-гэпы, vs/alternative-страницы под SEO. Триггеры: «vs страница», «профиль конкурента».
...
**Перед началом прочитай `~/.hermes/ccpack/business-context.md`** — разделы «Продукт» (чем отличаешься и что альтернативы делают лучше), «Позиционирование» (в какой категории тебя ищут и с кем сравнивают) и «Цены». Файла нет — заведи из `~/.hermes/ccpack/templates/business-context.md`.
