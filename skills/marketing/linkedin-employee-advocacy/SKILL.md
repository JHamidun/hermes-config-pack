...
description: "Ставит программу, при которой в LinkedIn пишет команда."
user_description: "Ставит программу, при которой в LinkedIn пишет команда, а не только страница компании: план запуска на две недели, посильный ритм постов, правила согласования и подсчёт отдачи. Нужен, когда сотрудники должны публиковаться регулярно и своим голосом, а не под копирку."
version: 1.0.0
license: MIT
metadata:
  hermes:
    category: marketing
    tags: [linkedin, employee, advocacy]
    source: claude-code-config-pack
---
## Когда применять

Employee advocacy в LinkedIn: 14-дневный запуск, посты сотрудников, governance, ROI. Триггеры: «сотрудники должны постить», «раскачать команду в linkedin».
