...
description: "Переносит свёрстанную веб-презентацию в PowerPoint так."
user_description: "Переносит свёрстанную веб-презентацию в PowerPoint так, что каждый заголовок и абзац остаётся живым текстом, а не картинкой: шрифты, цвета и расположение блоков сохраняются. Нужен, когда файл уйдёт заказчику или коллегам и они должны править текст сами, прямо в PowerPoint."
version: 1.0.0
license: MIT
metadata:
  hermes:
    category: presentations
    tags: [pptx, editable, extractor, playwright, python, node, image]
    source: claude-code-config-pack
---
## Когда применять

HTML → редактируемый PPTX: каждый текст-узел — нативный TextBox, правится в PowerPoint. Триггеры: «pptx с editable text». НЕ скриншоты→export-pptx.
