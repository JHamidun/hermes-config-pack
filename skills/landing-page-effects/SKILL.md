...
description: "Библиотека из полусотни готовых эффектов для лендинга."
user_description: "Библиотека из полусотни готовых эффектов для лендинга: глитч, неоновые кнопки, свой курсор, появление блоков при прокрутке, плюс подобранный набор шрифтов и тёмная палитра. Нужна, чтобы один и тот же эффект на всех ваших страницах выглядел одинаково, а не переписывался каждый раз заново."
version: 1.0.0
license: MIT
metadata:
  hermes:
    category: design-and-ui
    tags: [landing, page, effects]
    source: claude-code-config-pack
---
## Когда применять

Библиотека 50+ эффектов лендингов: шрифты, тёмная неоновая палитра, Tilda SBS-анимации. Триггеры: «эффекты лендинга», «глитч», «неоновая кнопка», «кастомный курсор».
