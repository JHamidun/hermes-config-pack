#!/usr/bin/env python3
"""Test ScraperVendor GitHub device auth flow from the CLI.
...
BASE = "https://api.your-scraper.example/v1/github/device"
...
def main():
    ...
    print("Starting ScraperVendor GitHub device auth...\n")
    try:
    ...
    if api_key:
        print("=" * 50)
        print(f"Your Scraping API key: {api_key}")
        print("=" * 50)
        print(f"\nTo use it: echo 'SCRAPER_API_KEY={api_key}' >> ~/.config/last30days/.env")
    else:
