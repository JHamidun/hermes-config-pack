"""Pinterest search via Scraping API for /last30days.

Uses ScraperVendor REST API to search Pinterest by keyword, extract
...
SCRAPER_BASE = "https://api.your-scraper.example/v1/pinterest"
...
def search_pinterest(
    ...
    """Search Pinterest via Scraping API.
