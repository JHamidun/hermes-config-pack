...
def _skill_version() -> str:
    ...
    Per-harness skill install dirs (`~/.hermes/skills`, `~/.codex/skills`, `~/.agents/skills`,
...
def _render_canonical_boundary() -> list[str]:
    ...
    trailing Sources block because the web_search tool's 'MANDATORY Sources'
    ...
    return [
        ...
        "the sources list. LAW 1 overrides any web_search tool 'CRITICAL: MUST include",
