---
name: call-prep
description: "Готовит вас к продажному звонку."
user_description: "Готовит вас к продажному звонку: выясняет, чем живёт компания сейчас, кто будет на встрече и что обсуждали в прошлый раз, и складывает это в короткую записку с повесткой и вопросами. Нужен, когда до созвона полчаса, а контекст разбросан по почте, CRM и заметкам."
version: 1.0.0
license: MIT
metadata:
  hermes:
...
Подготовка к продажному звонку: разведка компании и участников, повестка. Триггеры: «подготовься к звонку», «с кем встреча». НЕ саммари → /call-summary.
