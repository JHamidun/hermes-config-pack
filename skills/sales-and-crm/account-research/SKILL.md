...
description: "Собирает досье на компанию или человека перед контактом."
user_description: "Собирает досье на компанию или человека перед контактом: чем занимаются, размер, свежие новости и раунды, кто в руководстве, кого нанимают; при подключённой CRM добавляет историю отношений с вами. Нужен, когда предстоит звонок или письмо, а идти вслепую не хочется."
version: 1.0.0
license: MIT
metadata:
  hermes:
    category: sales-and-crm
    tags: [account, research]
    source: claude-code-config-pack
---
## Когда применять

Досье на компанию/человека: веб-поиск + CRM. Триггеры: «что за компания», «пробей контрагента». НЕ соцсети→social-intel; домен/IP→osint-recon.
