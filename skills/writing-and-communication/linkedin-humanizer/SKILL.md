...
description: "Чистка EN-текстов LinkedIn от AI-tells."
user_description: "Переписывает англоязычный текст так, чтобы из него ушли приметы машинного письма, и показывает построчно, что именно поменялось и почему. Жёсткость выбираете вы: только очевидные следы нейросети, или ещё и корпоративный канцелярит, или полная зачистка стиля. Нужен перед публикацией поста или комментария, написанного с помощью ИИ."
version: 1.0.0
license: MIT
metadata:
  hermes:
    category: writing-and-communication
    tags: [linkedin, humanizer, git, claude]
    source: claude-code-config-pack
---
## Когда применять

Чистка EN-текстов LinkedIn от AI-tells: humanize 3 tiers, emoji-детектор, тест детекторов GPTZero/ZeroGPT. Триггеры: «убери AI tells», «детекторы AI». НЕ русские тексты→de-ai-ify.
