...
- Author's team meeting test (2026): scored a hand-written article **100% AI** while GPTZero scored the same article 82% and ZeroGPT scored 50%. 50-point spread on identical text.

**Citation**: Internal team test meeting transcript (`(internal test transcripts)`); also referenced in an a practitioner LinkedIn post on detector unreliability.
...
Reference: OpenAI blog, "New AI classifier for indicating AI-written text" (MMM DD, 2023), updated July 2023 with discontinuation notice.
...
- **50 points** — spread observed on a single article in team testing (2026)
