...
description: "Разбирает профиль LinkedIn по девяти частям."
user_description: "Разбирает профиль LinkedIn по девяти частям — фото, баннер, заголовок, раздел «О себе», избранное, опыт, навыки, адрес страницы, рекомендации — ставит каждой оценку и переписывает те, что провалились, под вашу цель: клиенты, работа или экспертность. Нужен, когда профиль выглядит как резюме и не превращает посетителей в обращения."
version: 1.0.0
license: MIT
metadata:
  hermes:
    category: writing-and-communication
    tags: [linkedin, profile, optimizer]
    source: claude-code-config-pack
---
## Когда применять

Аудит и переписывание профиля LinkedIn: headline, About, Featured, баннер, навыки. Триггеры: «профиль linkedin», «перепиши headline», «аудит профиля».
