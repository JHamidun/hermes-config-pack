...
**Reference:** Jake Ward, 4,240 eng. Canonical draft: `01-platform-risk-anaphora.md`.
...
**Reference:** Alex Vacca, 3,822 eng. Canonical draft: `02-rip-obituary.md`.
...
**Reference:** Cam Trew, 494 eng (3.74x baseline). Canonical draft: `03-year-over-year-pivot.md`.
...
**Reference:** Lara Acosta, 1,519+ eng. Canonical draft: `04-time-anchor-confession.md`.
...
**Reference:** Noam Nisand, 1,082 eng / 435 comments. Canonical draft: `05-self-proving-meta.md`.
...
**Reference:** Richard Illingworth, 717-3,008 eng. Canonical draft: `06-comment-gate-leadmagnet.md`.
...
**Reference:** Jake Ward, 1,755 eng (9.4x baseline). Canonical draft: `07-odd-precision-money.md`.
...
**Reference:** Richard Illingworth, 550 eng (19.64x baseline — highest multiplier in the set). Canonical draft: `08-paid-vs-free-reversal.md`.
...
**Why:** Reversal hook (price → free) creates pattern interrupt. Named framework signals proprietary thinking. Checklist drives saves (5x likes under EnterpriseTool).

---

## F9 — Curiosity-Gap Teaser

**Reference:** PublicCreator4, 306 eng (4.25x baseline). Canonical draft: `09-curiosity-gap-teaser.md`.
...
**Reference:** Jake Ward, 3,083 eng. Canonical draft: `10-contrarian-historical.md`.
