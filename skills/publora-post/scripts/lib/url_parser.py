...
def parse_linkedin_url(url: str) -> ParsedLinkedInUrl:
    ...
    >>> p = parse_linkedin_url("https://www.linkedin.com/posts/janedoe_activity-7448808898326654978-iW20")
    >>> p["post_activity_id"]
    '7448808898326654978'
    >>> p["post_urn"]
...
if __name__ == "__main__":
    ...
    examples = sys.argv[1:] or [
        ...
        "https://www.linkedin.com/posts/johnsmith_one-broker-share-7449499107418669056-ZYt7",
    ]
    for u in examples:
        print(u)
