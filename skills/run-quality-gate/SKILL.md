...
description: "Прогон quality gate: type-check, build, tests."
version: 1.0.0
license: MIT
metadata:
  hermes:
    category: code-quality-and-review
    tags: [run, quality, gate]
    source: claude-code-config-pack
    requires_tools: [read_file, terminal]
---
## Когда применять

Прогон quality gate: type-check, build, tests, lint со структурным отчётом. Служебный. Триггеры: «прогони проверки», «проверь перед мержем».
