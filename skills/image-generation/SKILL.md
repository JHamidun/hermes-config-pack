...
Промпт-инжиниринг генерации картинок (Nano Banana, gpt-image-2.5, Midjourney, SD) + сюрреализм-пресет «эксперт / Магритт-Дали». Триггеры: «креатив для vk ads», «сюрреализм магритт».
