---
name: daily-briefing
description: "Утренний sales-брифинг: встречи, сделки, приоритеты дня."
user_description: "Собирает утренний брифинг продавца: встречи на сегодня, сделки, которые требуют внимания, письма без ответа — и раскладывает всё по приоритету на одну страницу. Нужен, когда день начинается с десятка открытых вкладок, а решить, за что взяться первым, надо за две минуты."
version: 1.0.0
license: MIT
metadata:
  hermes:
...
Утренний sales-брифинг: встречи, сделки, приоритеты дня. Триггеры: «утренний брифинг», «с чего начать день».
