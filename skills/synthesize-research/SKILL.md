...
description: "Synthesize user research from interviews, surveys."
version: 1.0.0
license: MIT
metadata:
  hermes:
    category: commands
    tags: [synthesize, research]
...
```
/synthesize-research текст, который пользователь написал вместе с вызовом навыка
```
