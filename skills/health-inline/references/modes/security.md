...
**Invoke security-scanner** via delegate_task tool:
...
4. Update todo: mark detection complete
...
2. **Update todo**: mark current priority in_progress

3. **Invoke vulnerability-fixer** via delegate_task tool:
   ```
...
5. **Update todo**: mark priority complete
...
1. **Update todo**: mark verification in_progress
