...
`mcp_claude_in_chrome_*` tools — they are slow, unreliable, and not what this
project uses.
...
- During large refactors, remove the symlink (`rm .claude/skills/gstack`) so the
  global install at `~/.hermes/skills/browser-and-automation/gstack/` is used instead
...
- No jargon: say "every question now tells you which project and branch you're in" not
  "clarify format standardized across skill templates via preamble resolver."
...
The active skill lives at `~/.hermes/skills/browser-and-automation/gstack/`. After making changes:

1. Push your branch
2. Fetch and reset in the skill directory: `cd ~/.hermes/skills/browser-and-automation/gstack && git fetch origin && git reset --hard origin/main`
3. Rebuild: `cd ~/.hermes/skills/browser-and-automation/gstack && bun run build`

Or copy the binary directly: `cp browse/dist/browse ~/.hermes/skills/browser-and-automation/gstack/browse/dist/browse`
