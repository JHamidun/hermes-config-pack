---
name: gstack-ship
description: "Ship workflow: detect + merge base branch, run tests."
version: 1.0.0
license: MIT
metadata:
  hermes:
    category: browser-and-automation
    tags: [gstack, ship, git, sql, claude]
...
6. **If CRITICAL issues found:** For EACH critical issue, use a separate clarify with:
...
**VALID & ACTIONABLE:** Use clarify with:
...
**VALID BUT ALREADY FIXED:** Reply using the **Already Fixed reply template** from greptile-triage.md — no clarify needed:
- Include what was done and the fixing commit SHA
- Save to both per-project and global greptile-history (type: already-fixed)

**FALSE POSITIVE:** Use clarify:
...
**If TODOS.md does not exist:** Use clarify:
...
**If disorganized** (missing priority fields, no component groupings, no Completed section): Use clarify:
...
- **Never ask for confirmation** except for MINOR/MAJOR version bumps and CRITICAL review findings (one clarify per critical issue with fix recommendation).
