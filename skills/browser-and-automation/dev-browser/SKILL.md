---
name: dev-browser
description: "Водит браузер по шагам, не теряя состояние страницы между."
user_description: "Водит браузер по шагам, не теряя состояние страницы между действиями: заходит на сайт, логинится, заполняет формы, снимает скриншоты, а в режиме расширения работает прямо в вашем Chrome под уже открытыми сессиями. Нужен, когда нужное лежит за авторизацией и одним обращением к странице не обойтись."
version: 1.0.0
license: MIT
metadata:
  hermes:
    category: browser-and-automation
    tags: [dev, browser, playwright, git]
    source: claude-code-config-pack
---
## Когда применять

Браузер с сохранением состояния страницы: формы, скриншоты, логин. Триггеры: «зайди на сайт», «залогинься». НЕ e2e-тесты→playwright-automation; тест своего фронта→webapp-testing.
