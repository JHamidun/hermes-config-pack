...
description: "Продуктовые метрики: OKR, north star, дашборды."
user_description: "Выстраивает систему продуктовых метрик: главную метрику ценности, показатели по этапам жизни пользователя, цели и OKR, макет дашборда и сценарий еженедельного разбора. Нужен, когда цифр в аналитике много, а понимания, что на самом деле происходит с продуктом и на что жать, нет."
version: 1.0.0
license: MIT
metadata:
  hermes:
...
Продуктовые метрики: OKR, north star, дашборды, еженедельные разборы. Триггеры: «продуктовые метрики», «собери дашборд метрик».
