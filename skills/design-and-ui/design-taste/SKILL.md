---
name: design-taste
description: "Настраивает характер лендинга по трём шкалам."
user_description: "Настраивает характер лендинга по трём шкалам — насколько смело, насколько подвижно, насколько плотно — и заранее вычищает штампы, по которым страницу опознают как машинную. Нужен до начала вёрстки, когда хочется страницу с собственным лицом, а не очередной фиолетовый градиент с тремя карточками."
version: 1.0.0
license: MIT
metadata:
  hermes:
