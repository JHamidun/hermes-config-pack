---
name: text-to-lottie
description: "Собирает векторную анимацию в формате Lottie."
user_description: "Собирает векторную анимацию в формате Lottie — анимированную иконку, индикатор загрузки, короткую заставку — и сразу поднимает локальный просмотрщик, где её видно и можно проверить по кадрам. Нужен, когда анимация должна встать в сайт или приложение лёгким файлом, а не видеороликом."
version: 1.0.0
license: MIT
metadata:
  hermes:
    category: design-and-ui
    tags: [text, lottie, node, git, image]
    source: claude-code-config-pack
---
## Когда применять

Lottie (Bodymovin) JSON-анимация с рендером в skia-плеере. Триггеры: «лотти», «анимированная иконка», «лоадер», «after effects в json».
