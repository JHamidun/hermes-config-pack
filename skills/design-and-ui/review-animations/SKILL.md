...
Ревью анимаций и motion-кода по высокой планке ремесла (философия Emil Kowalski): по умолчанию флагует, одобрение нужно заслужить. Триггеры: «проверь анимацию», «ревью motion-кода», «анимация дёргается», «review animations».
