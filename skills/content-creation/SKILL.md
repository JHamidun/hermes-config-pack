...
description: "Пишет маркетинговые тексты по рабочим структурам."
user_description: "Пишет маркетинговые тексты по рабочим структурам: посты в соцсети, статьи в блог, письма рассылки, лендинги, клиентские кейсы и пресс-релизы. Нужен, когда текст нужен быстро и по делу, а начинать с чистого листа не хочется."
version: 1.0.0
license: MIT
metadata:
  hermes:
    category: marketing
    tags: [content, creation, video, image]
    source: claude-code-config-pack
---
## Когда применять

Generic маркетинг-копирайт: блог, соцсети, рассылки, лендинги, кейсы, SEO copy. Триггеры: «напиши пост», «копирайт».
