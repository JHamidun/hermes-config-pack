...
gstack skills are Markdown files that Claude Code discovers from a `skills/` directory. Normally they live at `~/.hermes/skills/browser-and-automation/gstack/` (your global install). But when you're developing gstack itself, you want Claude Code to use the skills *in your working tree* — so edits take effect instantly without copying or deploying anything.
...
```bash
~/.hermes/skills/browser-and-automation/gstack/bin/gstack-config set gstack_contributor true
```
...
- **Dev mode shadows your global install.** Project-local skills take priority over `~/.hermes/skills/browser-and-automation/gstack`. `bin/dev-teardown` restores the global one.
...
Claude Code falls back to `~/.hermes/skills/browser-and-automation/gstack/` automatically.
...
```bash
cd ~/.hermes/skills/browser-and-automation/gstack
git fetch origin
