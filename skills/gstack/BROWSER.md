...
- **Unnecessary abstraction**: Claude Code already has a terminal tool. A CLI that prints to stdout is the simplest possible interface.
...
1. Push your branch
2. Pull in the skill directory: `cd ~/.hermes/skills/browser-and-automation/gstack && git pull`
