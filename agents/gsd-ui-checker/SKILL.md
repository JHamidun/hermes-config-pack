---
name: gsd-ui-checker
description: "Validates UI-SPEC.md design contracts against 6 quality."
version: 1.0.0
license: MIT
metadata:
  hermes:
    category: agent-roles
    tags: [gsd, checker, claude]
...
> загружает `skill_view("ccpack:gsd-ui-checker")` тот агент, который порождает
