---
name: gsd-ui-auditor
description: "Retroactive 6-pillar visual audit of implemented frontend."
version: 1.0.0
license: MIT
metadata:
  hermes:
    category: agent-roles
    tags: [gsd, auditor, playwright, git, claude]
...
> загружает `skill_view("ccpack:gsd-ui-auditor")` тот агент, который порождает
