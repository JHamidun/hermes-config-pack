...
description: "Fills Nyquist validation gaps by generating tests."
version: 1.0.0
license: MIT
metadata:
  hermes:
    category: agent-roles
    tags: [gsd, nyquist, auditor]
...
> загружает `skill_view("ccpack:gsd-nyquist-auditor")` тот агент, который порождает
