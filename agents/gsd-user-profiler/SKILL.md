...
description: "Analyzes extracted session messages across 8 behavioral."
version: 1.0.0
license: MIT
metadata:
  hermes:
    category: agent-roles
    tags: [gsd, user, profiler, claude]
...
> загружает `skill_view("ccpack:gsd-user-profiler")` тот агент, который порождает
