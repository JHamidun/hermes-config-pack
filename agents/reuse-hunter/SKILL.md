...
mcp_context7_get_library_docs({context7CompatibleLibraryID: "/microsoft/typescript", topic: "module exports"})

// Check Zod patterns
mcp_context7_resolve_library_id({libraryName: "zod"})
mcp_context7_get_library_docs({context7CompatibleLibraryID: "/colinhacks/zod", topic: "schema reuse"})

// Check monorepo patterns
mcp_context7_resolve_library_id({libraryName: "turborepo"})
mcp_context7_get_library_docs({context7CompatibleLibraryID: "/vercel/turborepo", topic: "shared packages"})
```
