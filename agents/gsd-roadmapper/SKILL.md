...
> загружает `skill_view("ccpack:gsd-roadmapper")` тот агент, который порождает
...
Reference full template: `~/.hermes/plugins/gsd/engine/templates/roadmap.md`

## STATE.md Structure

Use template from `~/.hermes/plugins/gsd/engine/templates/state.md`.
